...
import { buildBaseSurveyStats, toHomeStats } from "./lib/surveyStats";
...
function App() {
  ...
  // Calculate summary statistics with shared logic
  const summaryStats = useMemo(() => {
    return toHomeStats(buildBaseSurveyStats(data));
  }, [data]);
  ...
  return (
    <Routes>
      ...
      <Route path="/survey" element={<SurveyTable data={data} />} />
